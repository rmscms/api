...
namespace RMS\Api\Support\Response\Concerns;
...
trait HandlesApiResponse
{
    ...
    {
        return app(ApiResponder::class)->success($data, $meta, $status, request());
    }

    protected function apiError(array $errors, int $status = 400, array $meta = []): JsonResponse
    {
        return app(ApiResponder::class)->error($errors, $status, $meta, request());
    }
